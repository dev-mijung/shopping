package com.nuri.shopping.mapper;
...
public interface UserMapper {
    ...
    public int insertData(@Param("idx")String idx, @Param("content") String conatent);
	 ...
	 * @return
	 */
	public int deleteProduct(@Param("checkArr")Integer checkArr);
	 ...
	 * @return
	 */
	public List<CartVO> selectCart(@Param("checkArr")Integer checkArr);
}
